function audioPlayer () { 
    ...
    const audioDuration = document.querySelector('.durationRange');    
    const timePicker = document.querySelector('.currentTimer');
    const durationTimer = document.querySelector('.durationTimer');
    const audioMute = document.querySelector('.audio__player_mute-on');
    const audioUnmute = document.querySelector('.audio__player_mute-off');
    const volumeChanged = document.querySelector('.audio__player_volume-change');
